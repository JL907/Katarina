...
namespace KatarinaMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        internal static Material KatarinaMat = Modules.Assets.CreateMaterial("KatarinaMat");
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = KatarinaPlugin.developerPrefix;
