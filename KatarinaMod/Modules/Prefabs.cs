...
namespace KatarinaMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            KatarinaPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            KatarinaPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            KatarinaPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
...
internal class BodyInfo
{
    ...
    // jump power per level exists for some reason
