...
namespace KatarinaMod.Modules
{
    public static class Config
    {
        ...
        public static void ReadConfig()
        {
            ...
            voracity_damageCoefficient = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("02 - Voracity Passive", "Damage Coefficient"), 6f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            bouncingBlades_damageCoefficient = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("04 - Bouncing Blades", "Damage Coefficient"), 4f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            deathLotus_procCoefficient = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("05 - Death Lotus", "Proc Coefficient"), 0.5f, new ConfigDescription("", null, Array.Empty<object>()));
