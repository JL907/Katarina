...
namespace KatarinaMod.Modules
{
    public static class Config
    {
        ...
        public static void ReadConfig()
        {
            ...
            voracity_damageCoefficient = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("02 - Voracity Passive", "Damage Coefficient"), 4.5f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            bouncingBlades_damageCoefficient = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("04 - Bouncing Blades", "Damage Coefficient"), 3.2f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            deathLotus_damageCoefficient = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("05 - Death Lotus", "Damage Coefficient"), 2f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            deathLotus_coolDown = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("05 - Death Lotus", "Cooldown"), 12f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            shunpo_damageCoefficient = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("06 - Shunpo", "Damage Coefficient"), 2f, new ConfigDescription("", null, Array.Empty<object>()));
