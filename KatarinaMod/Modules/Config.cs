...
namespace KatarinaMod.Modules
{
    public static class Config
    {
        ...
        public static void ReadConfig()
        {
            ...
            voracity_radius = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("02 - Voracity Passive", "Radius"), 10f, new ConfigDescription("", null, Array.Empty<object>()));
            voracity_shunpoRecharge = KatarinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("02 - Voracity Passive", "Shunpo Recharge"), 4.5f, new ConfigDescription("", null, Array.Empty<object>()));
